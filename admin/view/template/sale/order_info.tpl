            ...
            <tbody>
              ...
              <tr>
                <td><?php echo $text_affiliate; ?>
                  <?php if ($affiliate) { ?>
                  (<a href="<?php echo $affiliate; ?>"><?php echo $affiliate_firstname; ?></a>)
                  <?php } ?></td>
      ...
      <div class="panel-body">
        <table class="table table-bordered">
          <thead>
            <tr>
              <?php if ($shipping_method) { ?>
              <td style="width: 100%;" class="text-left"><?php echo $text_shipping_address; ?>
                <?php } ?></td>
            </tr>
          </thead>
          <tbody>
