...
function addAddress() {
	...
	html += '    <div class="col-sm-10"><select name="address[' + address_row + '][zone_id]" id="input-zone' + address_row + '" class="form-control" onchange="zone(this, \'' + address_row + '\', \'0\');" class="form-control">';
	...
	html += '    <div class="col-sm-10"><select name="address[' + address_row + '][city]" id="input-zone' + address_row + '" class="form-control"><option value=""><?php echo $text_none; ?></option></select></div>';
	html += '  </div>';
...
function zone(element, index, city) {
  if (element.value != '') {
        $.ajax({
            url: 'index.php?route=customer/customer/zone&token=<?php echo $token; ?>&zone_id=' + element.value,
            dataType: 'json',
            beforeSend: function() {
