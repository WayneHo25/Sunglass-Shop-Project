...
// Tab
$_['tab_email_register']        = 'E-Mail 注册';
$_['tab_telephone_register']        = '手机号码注册';

// Error
$_['error_exists']         = '警告： 该邮箱地址已被注册、请换一个电子邮箱！';
$_['error_telephone_exists']       = '警告：该手机号码已经被注册！';
$_['error_email_and_telephone_cannot_all_null']   = '警告：手机号码和邮箱不能都为空！';
$_['error_firstname']      = '名字必须在1到32字符之间！';
$_['error_email']          = '无效的邮箱地址！';
$_['error_telephone']      = '电话号码必须为2到32字节！';
$_['error_address_1']      = '地址长度必须在2到128字符之间！';
$_['error_city']           = '区/县名必须在2到128字节之间！';
